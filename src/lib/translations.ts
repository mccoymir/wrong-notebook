...
export const translations = {
    en: {
        ...
        practice: {
            ...
            batchTitle: "Batch Practice",
            batchSubtitle: "Practice each generated question one by one.",
            generate: "Generate Practice Question",
            generateAll: "Generate All Questions",
            generating: "Generating AI Question...",
            generatingAll: "Generating all questions...",
            saveQuestion: "Save Question",
            savingQuestion: "Saving...",
            savedQuestion: "Saved",
            saveSuccess: "Practice question saved successfully!",
            saveFailed: "Failed to save practice question.",
            ...
            savedTitle: "Saved Practice",
            savedSubtitle: "Review the practice questions you decided to keep.",
            emptySaved: "No saved practice questions yet.",
            showDetails: "Show Answer & Analysis",
            hideDetails: "Hide Answer & Analysis",
            viewSource: "View Source Error Item",
            referenceDiagram: "Reference Diagram",
    ...
    zh: {
        ...
        practice: {
            ...
            batchTitle: "批量举一反三",
            batchSubtitle: "多题连续练习，逐题检验掌握情况。",
            generate: "生成练习题",
            generateAll: "开始生成所有题目",
            generating: "AI 正在出题...",
            generatingAll: "正在生成所有题目...",
            saveQuestion: "保存题目",
            savingQuestion: "保存中...",
            savedQuestion: "已保存",
            saveSuccess: "练习题已保存！",
            saveFailed: "保存练习题失败，请重试。",
            regenerate: "重新生成",
            ...
            nextQuestion: "下一题",
            savedTitle: "已保存练习",
            savedSubtitle: "集中查看你想保留下来的举一反三题目。",
            emptySaved: "还没有保存的练习题。",
            showDetails: "查看答案与解析",
            hideDetails: "收起答案与解析",
            viewSource: "查看来源错题",
            referenceDiagram: "参考图形",
